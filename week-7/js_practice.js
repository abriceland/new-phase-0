...
//     groups.push(backwardsArray.splice(0,3));
//   }
  
//   for (var i = 0; i < groups.length; i++) {
//     groups[i] = groups[i].reverse().join('');
//   }
...
//     if (current_num < smallNum) {
//       smallNum = current_num;
//     }
//   }
//   return smallNum;
// }  
  
// console.log(smallestNumber([6, 9, 3, 1]));
...
//     currentCount = stringArray.map( function(element) {
//       if (element === current) {
//         return element;
//       }
...
// console.log(adding_up([5, 10, 15, 20, 25]));
...
// function turn(array, wordToFind) {
//   for (var i = 0; i < array.length; i++) {
//     var currentWord = array[i];
//       if (currentWord.indexOf(wordToFind) > -1) {
//         return currentWord;
//       }
      
//   }
//   return "That substring is not in this array";
  
// }

// console.log(turn(["grasping", "turning", "running", "fighting"], "turn"));
